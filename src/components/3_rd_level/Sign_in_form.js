    ...
    return (
        <div className={`row col-12 m-0`}>
            ...
            <div className='col-12 col-md-6'>
                ...
                <div className={`${styles.pass_div}`}/>
                <div className={`col-12 align-self-center ${styles.instruct_1} ${styles.pass_div}`}>Password must have
                    at
                ...
                <div className={`col-12 align-self-center ${styles.instruct_2} ${styles.pass_div}`}>Please re-enter your
                    password
                </div>
