...
const HeaderWhite = () => {
    return (
        <div className='jumbotron-fluid m-0'>
            <div className={`container-fluid d-inline-flex flex-wrap align-items-center justify-content-around m-0 pt-4 pb-4
                 ${styles.headerWhite}
            `}>
                <img type='button' src={logoWhite} className={`img-fluid col-7 col-md-5 col-lg-2 ${styles.logoWhite}`}/>

                {/*<button className={`${styles.logoBut}`}>*/}
                {/*    <h1 className={`${styles.greenLogo}`}>Pr<i className="fa fa-search"/>PETS</h1>*/}
                {/*</button>*/}
                <div>
